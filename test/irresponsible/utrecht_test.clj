...
(when-not (contains? (:pgjdbc-ng config) :username)
  (println "* pgjdbc-tests will fail, doesn't support auto-username, please set UTRECHT_TEST_USER"))
